...
function draw() {
    ...
    if (!keyDown("space")) {
        ...
        textSize(25);
        text("Press 'Space' to start helicopter", windowWidth / 2.5, windowHeight - windowHeight + 40);
        text("Press 'DownArrow' to drop package", windowWidth / 2.5, windowHeight - windowHeight + 70);
    }
    // box4.display();
}

function package_move() {
    package.velocityX = 0.5;
    package.velocityY = 4;
